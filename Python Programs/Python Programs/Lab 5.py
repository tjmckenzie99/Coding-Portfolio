...
#Displays title and sets a dictionary
...
#for loop to display the letter grade and calculate credit hours.
...
#Calculates GPA, Deans List, and Academic Probation
...
#If there is division by zero displays one credits
...
#6.
#Inputs: 2,P,6,B,3
#Outputs: *** No quality points awarded for invalid grade ***, 9.0, 9.0, 1.0
#7. 
#Inputs: 0
